<section id="realization" class="my-3 {{ (isset($hide) && $hide) ? 'd-none' : '' }}">
    <div class="container bg-white my-3 py-3 xpx-5">

        <div class="row">
            <div class="col-md-6">
                <div class="">
                    <img src="{{ $realization->photo }}" alt="{{ $realization->title }}"
        ...
        <div class="row mt-3">
            <div class="col bg-zero-brown mx-3">
                <div class="text-light my-3 px-3 px-lg-5 py-3">
                    <pre class="text-light">{{ $realization->technical }}</pre>
                </div>
            </div>
            <div class="col bg-black mx-3">
                <div class="text-light m-3 p-3 p-lg-5">
                    <p>Meer weten?</p>
                    <a href="{{ $realization->url }}" class="btn btn-outline-light" target="_blank">Bekijk de details</a>
                </div>
            </div>
        </div>
